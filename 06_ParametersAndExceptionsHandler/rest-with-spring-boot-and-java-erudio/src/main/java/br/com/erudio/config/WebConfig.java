...
public class WebConfig implements WebMvcConfigurer{
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		configurer.favorParameter(Boolean.TRUE).parameterName("mediaType").ignoreAcceptHeader(Boolean.TRUE)
					.useRegisteredExtensionsOnly(Boolean.FALSE).defaultContentType(MediaType.APPLICATION_JSON)
	...
	*/
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		configurer.favorParameter(Boolean.FALSE).ignoreAcceptHeader(Boolean.FALSE)
		.useRegisteredExtensionsOnly(Boolean.FALSE).defaultContentType(MediaType.APPLICATION_JSON)
		.mediaType("json", MediaType.APPLICATION_JSON).mediaType("xml", MediaType.APPLICATION_XML)
