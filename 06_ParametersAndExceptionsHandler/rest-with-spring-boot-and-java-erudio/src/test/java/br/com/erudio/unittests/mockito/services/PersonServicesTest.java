...
class PersonServicesTest {
	...
	void testFindAll() {
		...
		assertNotNull(person1.toString().contains("links: [</api/person/v1/1>;rel=\"self\"]"));
		...
		assertNotNull(person4.toString().contains("links: [</api/person/v1/4>;rel=\"self\"]"));
		...
		assertNotNull(person7.toString().contains("links: [</api/person/v1/7>;rel=\"self\"]"));
